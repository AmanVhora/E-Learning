ActiveAdmin.register Teacher do
  ...
  #
  permit_params :email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :first_name, :last_name, :phone_no, :gender, :education, :birth_date, :profile_photo
  #
  # or
  #
  # permit_params do
